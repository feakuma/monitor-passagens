...
var AEROPORTOS = [
  // BRASIL
  { code:'CGH', name:'Congonhas',                    city:'Sao Paulo, SP',        icon:'🏙️' },
  { code:'GRU', name:'Guarulhos',                    city:'Sao Paulo, SP',        icon:'🏙️' },
  { code:'VCP', name:'Viracopos',                    city:'Campinas, SP',         icon:'🏙️' },
  { code:'FLN', name:'Hercilio Luz',                 city:'Florianopolis, SC',    icon:'🏖️' },
  { code:'GIG', name:'Galeao',                       city:'Rio de Janeiro, RJ',   icon:'🗻' },
  { code:'SDU', name:'Santos Dumont',                city:'Rio de Janeiro, RJ',   icon:'🗻' },
  { code:'BSB', name:'Juscelino Kubitschek',         city:'Brasilia, DF',         icon:'🏛️' },
  { code:'SSA', name:'Luis Eduardo Magalhaes',       city:'Salvador, BA',         icon:'⛪' },
  { code:'REC', name:'Guararapes',                   city:'Recife, PE',           icon:'🌊' },
  { code:'FOR', name:'Pinto Martins',                city:'Fortaleza, CE',        icon:'🏖️' },
  ...
  { code:'CNF', name:'Tancredo Neves',               city:'Belo Horizonte, MG',   icon:'⛰️' },
  { code:'IGU', name:'Cataratas',                    city:'Foz do Iguacu, PR',    icon:'💧' },
  { code:'NVT', name:'Victor Konder',                city:'Navegantes, SC',       icon:'🏖️' },
  { code:'NAT', name:'Sao Goncalo do Amarante',      city:'Natal, RN',            icon:'🏖️' },
  { code:'MCZ', name:'Zumbi dos Palmares',           city:'Maceio, AL',           icon:'🏖️' },
  { code:'JPA', name:'Castro Pinto',                 city:'Joao Pessoa, PB',      icon:'🏖️' },
  // ARGENTINA
  ...
  { code:'COR', name:'Ambrosio Taravella',           city:'Cordoba, AR',          icon:'🏛️' },
  { code:'MDZ', name:'El Plumerillo',                city:'Mendoza, AR',          icon:'🍇' },
  { code:'BRC', name:'Teniente Candelaria',          city:'Bariloche, AR',        icon:'⛷️' },
  { code:'IGR', name:'Cataratas del Iguazu',         city:'Puerto Iguazu, AR',    icon:'💧' },
  { code:'USH', name:'Malvinas Argentinas',          city:'Ushuaia, AR',          icon:'🐧' },
  { code:'SLA', name:'Martin Miguel de Guemes',      city:'Salta, AR',            icon:'🏔️' },
  // PORTUGAL
